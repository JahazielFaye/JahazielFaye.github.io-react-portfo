        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              ...
              JavaScript. I&rsquo;m also looking forward to gaining experience
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              <span className="text-yellow-500"> Developer,</span> I&rsquo;m
              excited and passionate about creating meaningful and engaging
              digital experiences that will delight users and drive business
              results. With a background in both{" "}
              <span className="text-purple-500">Design</span> and{" "}
              <span className="text-indigo-500">Development,</span> I bring a
              unique perspective to every project and thrive in collaborative
              environments where I can work closely with cross-functional teams
              to bring ideas to life. Whether I&rsquo;m designing a sleek
              interface, writing clean code, or troubleshooting a technical
              issue, I&rsquo;m constantly learning and pushing myself to improve
              my skills and deliver exceptional work
            </p>
            <h3 className="text-4xl py-1 dark:text-white ">Services</h3>
          </div>
        </section>
        <section>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
              ...
              <p className="py-2">
                Creating elegant and responsive Designs suited for your needs
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="py-2">
                ...
                <br />
                <span className="text-gray-800 py-1">
                  Website Design/Redesign Database
                </span>
                <br />
                <span className="text-gray-800 py-1">
                ...
                <br />
                <span className="text-gray-800 py-1">
                  GitHub MERN Stack: MongoDB, Express, ReactJS, and Node.js
                </span>
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              <span className="text-teal-500"> My Recent Work </span>
               and <span className="text-teal-500">Collaboration </span>
              with talented people to create Digital products for both business
              and consumer use.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
            I Offer a wide range of services, including brand design, programming, and editing. These services are available for
           both business and consumer use. 
            I have worked on collaborations with talented people to create digital products. 
            My recent work includes both business and consumer products
            </p>
          </div>
